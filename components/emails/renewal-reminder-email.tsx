...
<head>
  ...
  <title>Renewal Reminder - Amy</title>
</head>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; background-color: #ffffff; border-radius: 8px;">
          ...
          <tr>
            <td style="padding: 40px;">
              <h2 style="margin: 0 0 16px 0; font-size: 20px; font-weight: 600; color: #000000;">Renewal Reminder</h2>
              <p style="margin: 0 0 24px 0; font-size: 16px; line-height: 1.6; color: #000000;">
                Hi ${displayName},
              </p>
              <p style="margin: 0 0 24px 0; font-size: 16px; line-height: 1.6; color: #000000;">
                This is a friendly reminder that your subscription <strong>${subscriptionName}</strong> will renew in ${daysUntilRenewal} ${daysText}.
              </p>
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td style="font-size: 16px; color: #707070;">
                      Renewal Date: <strong style="color: #000000;">${formattedDate}</strong>
                    </td>
                  </tr>
                </table>
              </div>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin: 32px 0;">
                <tr>
                  <td align="center">
                    <a href="${dashboardUrl}" style="display: inline-block; padding: 12px 24px; background-color: #000000; color: #ffffff; text-decoration: none; border-radius: 6px; font-size: 16px; font-weight: 500;">View Dashboard</a>
                  </td>
                </tr>
              </table>
